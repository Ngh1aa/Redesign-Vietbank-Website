  ...
  return (
    <>
      <PageHeader
        ...
        lead="So sánh các dòng thẻ Vietbank bằng hình ảnh sản phẩm và thông tin đang được công bố trên kênh chính thức."
      />
          ...
          {CARDS.map(({ index, name, tag, desc, points, href, image, imageAlt }, rowIndex) => (
            ...
            >
              <div className="relative flex min-h-[170px] items-center justify-center bg-soft px-5 py-6">
                ...
                />
                <span className="absolute left-3 top-3 text-xs font-semibold text-ink-soft tnum" aria-hidden="true">
                  {index}
                </span>
              </div>
              ...
              <div className="px-1 pb-1 md:pr-2">
                <div className="flex flex-wrap items-center gap-3">
                  <span className="border-l-2 border-navy pl-3 text-xs font-semibold text-ink-soft">
                    {tag}
                  </span>
      ...
      <Section tone="soft">
        ...
        <div className="mt-6 overflow-x-auto border border-line bg-surface">
          <table className="w-full min-w-[920px] text-left">
            ...
            <thead>
              <tr className="border-b border-line bg-navy-050 text-xs text-ink-soft">
      ...
      <Section>
        <SectionHead
          ...
          lead="Điều kiện sản phẩm có thể thay đổi theo thời điểm. Hãy kiểm tra nguồn chính thức trước khi gửi yêu cầu đăng ký."
        />
        ...
        <div className="mt-5 flex items-start gap-3 border-l-2 border-navy bg-navy-050 px-4 py-3 text-[13px] leading-relaxed text-ink-soft">
          ...
          <p>Trang này không hiển thị số thẻ, hạn mức được duyệt hay trạng thái hồ sơ. Mọi yêu cầu mở thẻ được chuyển tới hệ thống Vietbank chính thức.</p>
        </div>
      </Section>
