...
const CARDS = [
  {
    ...
    points: [
      ...
      "Hạn mức công bố 10-500 triệu",
      "Ưu đãi tại hệ thống đối tác Visa",
    ],
...

  {
    ...
    points: [
      "Miễn lãi tối đa 55 ngày",
      "Hạn mức công bố 5-500 triệu",
      "Miễn phí phát hành & thường niên thẻ phụ",
    ],
...
const COMPARE_ROWS = [
  {
    feature: "Nhu cầu nổi bật",
    myStyle: "Chi tiêu hằng ngày",
    luxury: "Đặc quyền cao cấp",
    happy: "Chi tiêu gia đình",
    lifecare: "Sức khỏe",
  },

  {
    feature: "Thời gian miễn lãi công bố",
    myStyle: "Tối đa 55 ngày",
    luxury: "Xem điều kiện Vietbank",
    happy: "Tối đa 55 ngày",
    lifecare: "Tối đa 55 ngày",
  },

  {
    feature: "Hạn mức công bố",
    myStyle: "10-500 triệu",
    luxury: "Tới 1 tỷ",
    happy: "5-500 triệu",
    lifecare: "50 triệu-1 tỷ",
  },
  {
    feature: "Điểm khác biệt",
    myStyle: "Hoàn phí theo doanh số",
    luxury: "Phòng chờ thương gia",
    happy: "Chính sách thẻ phụ",
    lifecare: "Ưu đãi CIH",
  },

  {
    feature: "Digital Plus",
    myStyle: "Nhận thông báo OTT",
    luxury: "Nhận thông báo OTT",
    happy: "Nhận thông báo OTT",
    lifecare: "Nhận thông báo OTT",
  },
]
    ...
    <>
      ...
      <Section id="cards">
        <div className="flex flex-wrap items-end justify-between gap-5">
          ...
          />
          <ActionLink
            action={{ label: "Xem toàn bộ danh mục thẻ", href: OFFICIAL.cards }}
            variant="secondary"
            size="sm"
          />
        </div>
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {CARDS.map(
            ({ icon: Icon, name, tag, desc, points, href, featured }) => (
              <article
                key={name}
              ...
              >
                  ...
                  <span
                    className={`rounded border px-2.5 py-1 text-[12px] font-semibold ${
                      featured
                        ...
                        : "border-line bg-soft text-ink-soft"
                    }`}
                  >
                    {tag}
                  </span>
                ...
                <ul
                  className={`mt-4 flex flex-1 flex-col gap-2 text-[13.5px] ${
                    ...
                    <li key={p} className="flex items-start gap-2">
                      <Check
                        className={`mt-0.5 h-4 w-4 shrink-0 ${
                          featured ? "text-yellow" : "text-navy"
                        }`}
                      />{" "}
                      {p}
                    </li>
