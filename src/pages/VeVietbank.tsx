...
const VALUES = [
  {
    icon: HeartHandshake,
    title: "Nhu cầu khách hàng là trung tâm",
    body: "Vietbank công bố định hướng thấu hiểu nhu cầu khách hàng để xây dựng sản phẩm và dịch vụ phù hợp.",
  },

  {
    icon: ShieldCheck,
    title: "An toàn & tuân thủ",
    body: "Ngân hàng nhấn mạnh an toàn, kiểm soát rủi ro và tuân thủ trong quá trình tăng trưởng.",
  },

  {
    icon: Target,
    title: "Hiệu quả bền vững",
    body: "Phương châm được Vietbank công bố: Tăng trưởng, An toàn, Bền vững, Hiệu quả.",
  },
]
    ...
    <>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <SectionHead
              ...
              lead="Tìm hiểu tầm nhìn, sứ mệnh, phương châm hoạt động và các nguồn chính thức để đọc sâu hơn."
            />
            <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-ink-soft">
              Trên trang giới thiệu chính thức, Vietbank nhấn mạnh xây dựng ngân
              hàng bán lẻ hiện đại, tăng trưởng an toàn và hiệu quả; đồng thời
              phát triển sản phẩm dựa trên sự thấu hiểu nhu cầu khách hàng.
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <ActionLink
                action={{
                  label: "Tầm nhìn & giá trị cốt lõi",
                  href: OFFICIAL.visionValues,
                }}
                variant="secondary"
              />
              <ActionLink
                action={{
                  label: "Trang giới thiệu Vietbank",
                  href: OFFICIAL.about,
                }}
                variant="ghost"
              />
          ...
          <div className="relative min-h-[320px] overflow-hidden rounded-xl border border-line bg-navy-050">
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-navy/85 to-transparent p-6 pt-16 text-white">
              <p className="text-[12px] font-semibold uppercase tracking-[0.14em] text-white/60">
                Ảnh minh hoạ concept
              </p>
              <p className="mt-1 text-[14px] leading-relaxed text-white/80">
                Không đại diện cho một chi nhánh Vietbank cụ thể.
              </p>
            </div>
          </div>
        </div>
      ...
      <Section tone="soft">
        <SectionHead
          ...
          title="Chuyển giá trị thương hiệu thành trải nghiệm số"
        />
      ...
      <Section>
        <SectionHead
          ...
          lead="Các số liệu dưới đây được Vietbank công bố và ghi rõ thời điểm để tránh tạo cảm giác dữ liệu thời gian thực."
        />
        <div className="mt-6 grid gap-px overflow-hidden rounded-xl border border-line bg-line sm:grid-cols-3">
          <div className="bg-surface p-6">
            ...
            <div className="mt-4 font-display text-3xl font-semibold text-navy tnum">
              127
            </div>
            <p className="mt-1 text-[13.5px] leading-relaxed text-ink-soft">
              điểm giao dịch trên toàn quốc theo trang giới thiệu Vietbank.
            </p>
          </div>
          <div className="bg-surface p-6">
            ...
            <p className="mt-1 text-[13.5px] leading-relaxed text-ink-soft">
              cổ phiếu Vietbank chính thức niêm yết HOSE từ 14/07/2026.
            </p>
          </div>
          <div className="bg-surface p-6">
            ...
            <p className="mt-1 text-[13.5px] leading-relaxed text-ink-soft">
              tổng tài sản tại 30/06/2026 theo công bố kết quả 6 tháng đầu năm.
            </p>
          </div>
        </div>
      ...
      <Section tone="soft">
        <div className="flex flex-wrap items-end justify-between gap-5">
          ...
          />
          <ActionLink
            action={{ label: "Mở trung tâm tin tức", href: OFFICIAL.news }}
            variant="secondary"
            size="sm"
          />
        </div>
        <div className="mt-6 flex flex-col divide-y divide-line border-y border-line">
          {NEWS.map((item) => (
            <a
              ...
              href={OFFICIAL.news}
              {...EXTERNAL_LINK_PROPS}
              className="group flex items-start gap-4 py-4 transition-colors hover:bg-navy-050/60"
            >
              <div className="w-24 shrink-0">
                <span className="block rounded border border-line bg-surface px-2 py-0.5 text-center text-[12px] font-semibold text-ink-soft">
                  {item.tag}
                </span>
              ...
              <p className="text-[15.5px] font-medium leading-snug text-ink group-hover:text-navy">
                {item.title}
              </p>
      ...
      <Section>
        <SectionHead
          ...
          lead="Thông tin quản trị, công bố và đại hội cổ đông được tập trung trong luồng Nhà đầu tư để dễ tra cứu."
        />
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {[
            {
              title: "Quan hệ nhà đầu tư",
              body: "Công bố thông tin, báo cáo định kỳ, điều lệ và quản trị công ty.",
              action: { label: "Mở IR Vietbank", href: OFFICIAL.investor },
            },

            {
              title: "ĐHĐCĐ 2026",
              body: "Thông tin về Đại hội đồng cổ đông thường niên 2026 và các mục tiêu tăng trưởng đã thông qua.",
              action: { label: "Xem công bố", href: OFFICIAL.agm2026 },
            },

            {
              title: "Liên hệ & mạng lưới",
              body: "Địa chỉ, hotline, email và công cụ tìm chi nhánh/PGD do Vietbank quản lý.",
              action: { label: "Kênh liên hệ", href: OFFICIAL.contact },
            },
          ].map((item) => (
            <article
              key={item.title}
            ...
            >
              ...
              <div className="mt-4">
                <ActionLink action={item.action} variant="ghost" size="sm" />
              </div>
            </article>
          ))}
        </div>
