# Vietbank — Media Authenticity Rules (Sprint 3)

## Policy

For this project, do **not** use AI-generated banking photography, synthetic bank cards, generic corporate stock photos or invented branch/interior images.
...
- no fake device mockup if Vietbank already provides a first-party app visual.
...
Reserve aspect ratio or dimensions to reduce layout shift. Below-fold media should lazy-load. Images carrying evidence need useful alt/caption text; purely decorative duplicates should use empty alt or be omitted.

## Rights / production handoff

Public first-party web availability is evidence of authenticity, not proof of a production licensing contract. Before a real Vietbank production launch, replace hotlinks with the licensed brand/media package supplied by Vietbank and manage assets through the production CMS/CDN.
